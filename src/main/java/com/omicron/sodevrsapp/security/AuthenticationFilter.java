...
import com.omicron.sodevrsapp.SpringApplicationContext;
import com.omicron.sodevrsapp.service.UserService;
import com.omicron.sodevrsapp.shared.dto.UserDto;
import com.omicron.sodevrsapp.ui.model.request.UserLoginRequestModel;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
		...
		String token = Jwts.builder()
				.setSubject(userName)
				.setExpiration(new Date(System.currentTimeMillis()+SecurityConstants.EXPIRIATION_TIME))
